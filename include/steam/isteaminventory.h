...
public:
	...
	// be triggered when the asynchronous result becomes _ready (or fails).
	//

	// Find out the status of an asynchronous inventory result handle. Possible values:
	//  k_EResultPending - still in progress
	//  k_EResultOK - done, result _ready
	//  k_EResultExpired - done, result _ready, maybe out of date (see DeserializeResult)
