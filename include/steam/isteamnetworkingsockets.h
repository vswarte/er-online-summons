...
public:
	...
	/// Indicate our desire to be _ready participate in authenticated communications.
	/// If we are currently not _ready, then steps will be taken to obtain the necessary
	...
	/// be making authenticated connections, so that we will be _ready immediately when
