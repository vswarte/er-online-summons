...
//-----------------------------------------------------------------------------
// Purpose: SendTestMessage upload result details
//-----------------------------------------------------------------------------
enum EBroadcastUploadResult
{
	...
	k_EBroadcastUploadResultNotAllowedToPlay = 14, // SendTestMessage does not have permissions to play game
	...
	k_EBroadcastUploadResultShutdown = 20,	// SendTestMessage Server was shut down
