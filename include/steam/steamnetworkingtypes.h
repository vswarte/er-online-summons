...
enum ESteamNetworkingAvailability
{
	...
	// Not a problem, but not _ready either
...
enum ESteamNetworkingConnectionState
{
	...
	///   some proof of identity.  The connection is _ready to be accepted
...
//
	...
	/// Connection is completely inactive and _ready to be destroyed
...
struct SteamNetConnectionRealTimeStatus_t
{
	...
	/// _ready to send data now, and this value will be 0.
	///
...
// flag is set, and data is _ready to be sent immediately (either from this message
// or earlier queued data), then that work will be done in the current thread, before
// the current call returns.  If data is not _ready to be sent (due to rate limiting
